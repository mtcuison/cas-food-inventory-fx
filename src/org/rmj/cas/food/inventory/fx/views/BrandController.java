...
public class BrandController implements Initializable {
    ...
    private void txtField_KeyPressed(KeyEvent event) {
        ...
        switch (event.getCode()){
            case F3:
                if (lnIndex == 2){
                    JSONObject lsResult = qsParameter.getInvType(poGRider, txtField02.getText(), 1);
    ...
    private void cmdButton_Click(ActionEvent event) {
        ...
        switch (lsButton){
            case "btnBrowse":
                JSONObject lsResult = qsParameter.getBrand(poGRider, "", 1);
                
                if (lsResult != null){
                    openRecord((String) lsResult.get("sBrandCde"));
                }
                break;
            case "btnCancel":
    ...
    private void loadRecord(){
        ...
        if (poRecord.getMaster(2) != null && !poRecord.getMaster(2).toString().isEmpty()){
            JSONObject lsResult = qsParameter.getInvType(poGRider, (String) poRecord.getMaster(2), 0);
            loadInvType(lsResult);
        } else
            txtField02.setText("");
    ...
    private final String pxeModuleName = "BrandController";
