...
public class CategoryController implements Initializable {
    ...
    private void txtField_KeyPressed(KeyEvent event) {
        ...
        switch (event.getCode()){
            case F3:
                if (lnIndex == 3){
                    JSONObject lsResult = qsParameter.getInvType(poGRider, txtField03.getText(), 1);
    ...
    private void cmdButton_Click(ActionEvent event) {
        ...
        switch (lsButton){
            case "btnBrowse":
                JSONObject lsResult = qsParameter.getCategory(poGRider, "", 1);
    ...
    private void loadRecord(){
        ...
        if (poRecord.getMaster(3) != null && !poRecord.getMaster(3).toString().isEmpty()){
            JSONObject lsResult = qsParameter.getInvType(poGRider, (String) poRecord.getMaster(3), 0);
            loadInvType(lsResult);
        } else
            txtField03.setText("");
